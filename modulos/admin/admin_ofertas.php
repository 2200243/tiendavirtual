...
<h3 class="center" >Administrador de Ofertas</h3>
<div class="center mb-3">
    <a class="blue btn mx-auto center" href="?modulo=admin_agregar_oferta"><i class="material-icons right">add</i>Nueva Oferta</a>
</div>
