...
<div class="center mb-3">
    <a class="blue btn mx-auto center" href="?modulo=admin_agregar_producto"><i class="material-icons right">add</i>Nuevo Producto</a>
</div>
