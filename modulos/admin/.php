...
<div class="center mb-3">
    <a class="blue btn mx-auto center" href="?modulo=admin_agregar_saga"><i class="material-icons right">add</i>Nuevo Producto</a>
</div>
...
<table class="container white z-depth-1 mb-2 responsive-table" id="adminprod">
    ...
    <tbody>
        <?php
        $strsql= "SELECT a.idsaga, a.nombre_saga, categorias.nombre_categoria, a.descripcion, a.precio, a.cantidad, a.url_imagen , a.idcategoria FROM `sagas` a INNER JOIN categorias ON categorias.idcategoria=a.idcategoria";
            ...
            <td><a class="btn red" href="javascript:eliminar(<?php echo $idproducto?>)">Eliminar</a></td>
                   ...
                   <div id="modaleditarproducto-<?php echo $idproducto?>" class="modal modaleditarproducto">
                        ...
                        <form class="col s12" >
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                    <input id="prev-cat-<?php echo $idproducto?>" type="text"  value="<?php echo $idcategoria?> - <?php echo $nombre_categoria?>" size="100" disabled>
                                    <label for="prev-cat-<?php echo $idproducto?>">Categoria Actual</label>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    {
        var url = '<?php echo $urlweb?>servicios/ws_saga_detalles.php?accion=eliminar';
    ...
    function editar(idproducto){
        var url = '<?php echo $urlweb?>servicios/ws_saga_detalles.php?accion=editar';
        fetch(url, {
            method: 'POST',
            body: JSON.stringify({
            "idsaga": idproducto,
            "nombre_saga": document.getElementById("nombre_producto-"+idproducto).value,
            "idcategoria": document.getElementById("categoria-"+idproducto).selectedIndex,
